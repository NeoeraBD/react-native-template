  ...
  "Subagents": [
    {
      ...
      "Role": "Worker-A",
      "Workspace": "branch",
      "Prompt": "Execute auto-task on openspec/context/tasks.md as Worker-A. Claim pending tasks atomically with permission gate, propose, apply, test, archive, and repeat."
    },
    {
      "TypeName": "self",
      "Role": "Worker-B",
      "Workspace": "branch",
      "Prompt": "Execute auto-task on openspec/context/tasks.md as Worker-B. Claim pending tasks atomically with permission gate, propose, apply, test, archive, and repeat."
    }
  ]
}
```
